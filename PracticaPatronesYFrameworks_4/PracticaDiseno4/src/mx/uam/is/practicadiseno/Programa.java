...
public class Programa {
	 ...
	 * Busca primero en el directorio actual (opcional override); si no existe, en
	 * el classpath (src/main/resources).
	 */
	private static int cargarCantidadVentanas() {
		...
		try {
			...
			System.err
					.println("Valor inválido para " + KEY_CANTIDAD + " («" + valor + "»), usando " + DEFAULT_CANTIDAD);
